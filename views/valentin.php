...
<div id="valentin">
  <div class="card card-body backcol">
    <div class="row p-2">
      ...
      <div class="col-12 col-md-12 col-lg-6 p-3" id="kaspo1">
        ...
        <form class="p-2" action="/cart" method="POST">  
          <div class="row p-2" >
              ...
              <div class="col-6"><input class="w-30"  type="number" name="piece" size="5" min="1" max="<?php echo $kaspo1[$index]['piece'] ?>" <?php echo $kaspo1[$index]['piece'] === 0 ? "disabled" : "" ?>></input></div>
              <div class="col-6"><button type="submit" class="btn btn-block btn-success" <?php echo $kaspo1[$index]['piece'] === 0 ? "disabled" : "" ?>>Kosárba</button></div>
          </div>
          </form>
        </div>
      ...
      <div class="col-md-12 col-lg-6">
        ...
        <div class="termekleiras text-center py-3 m-2">
          ...
          <div class="row borbott text-left mx-2 p-2">
            ...
            <div class="col-8">35-77 dkg,</div>
          </div>
          <div class="row borbott text-left mx-2 p-2">
            <div class="col-4"><i class="fab fa-buffer"></i> Anyaga:</div>
            <div class="col-8">kaspó, hungarocell, fa, vetex, szatén, gyöngy, csipke, kő</div>
          </div>
        </div>
            ...
            <div class="col-12 col-md-6">
              ...
              <div class="col-12 pt-4">
                <div class="termekleiras text-center py-3 m-2">
                  ...
                  <div class="row borbott text-left mx-2 p-2">
                    <div class="col-4"><i class="fas fa-weight-hanging"></i> Súly:</div>
                    <div class="col-8">42-44 dkg,</div>
                  </div>
                  <div class="row borbott text-left mx-2 p-2">
                    <div class="col-4"><i class="fab fa-buffer"></i> Anyaga:</div>
                    <div class="col-8">kerámia, hungarocell, vetex, fa, szatén, gyöngy, csipke, strassz, kő</div>
                  </div>
                </div>
              </div>
            </div>
              ...
              <form class="p-2" action="/cart" method="POST">  
                 <div class="row p-2" >
                    <div class="col-6"><input type="hidden" name="id" value="<?php echo $kaspo2[$index2]["id"] ?>"/><h5 class="mellow" name="name"><?php echo $kaspo2[$index2]["name"] ?> </h5></div> 
                     ...
                     <div class="col-6"><input class="w-30" type="number" name="piece" size="5" min="1" max="<?php echo $kaspo2[$index2]['piece'] ?>" <?php echo $kaspo2[$index2]['piece'] === 0 ? "disabled" : "" ?>></input></div>
                     <div class="col-6"><button type="submit" class="btn btn-block btn-success" <?php echo $kaspo2[$index2]['piece'] === 0 ? "disabled" : "" ?>>Kosárba</button></div>
                 </div>
             </form>
              </div>
