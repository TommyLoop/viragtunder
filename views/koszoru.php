      ...
      <div class="col-12 col-lg-6 p-3">
        ...
        <form class="p-2" action="/cart" method="POST">  
          <div class="row p-2">
              ...
              <div class="row">
              <button type="button" id="koszoruDecrement" class="input-number-decrement" <?php echo $koszoru[$index]['piece'] === 0 ? "disabled" : "" ?>>–</button>
              <div id="koszoru1"><input id="koszoruPiece" class="input-number" name="piece" value="1" type="text" min="1" max="<?php echo $koszoru[$index]['piece'] ?>" <?php echo $koszoru[$index]['piece'] === 0 ? "disabled" : "" ?>></div>
              <button type="button" id="koszoruIncrement" class="input-number-increment" <?php echo $koszoru[$index]['piece'] === 0 ? "disabled" : "" ?>>+</button>
              </div>
              </div>
              <div class="col-6">
                <button type="submit" class="btn-block button" style="vertical-align:middle" <?php echo $koszoru[$index]['piece'] === 0 ? "disabled" : "" ?>><span>Kosárba</span></button>
              </div>
          </div>
          </form>
        </div>
