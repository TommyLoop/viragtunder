...
<div class="pt-4" id="kubli">
  <div class="card card-body backcol2">
    <div class="row p-2 m-2">
      ...
      <div class="col-12 col-md-12 col-lg-6 p-3" id="egyviragoskubli">
        ...
        <form class="p-2" action="/cart" method="POST" id="kubliOrderSubmit">  
          <div class="row p-2" id="NamePiece" >
              ...
              <div class="col-6"><input class="w-30" id="kubliOrder" type="number" name="piece" size="5" min="1" max="<?php echo $kublik[$index]['piece'] ?>" <?php echo $kublik[$index]['piece'] === 0 ? "disabled" : "" ?>></input></div>
              <div class="col-6"><button type="submit" id="kubliOrderSender" class="btn btn-block btn-success" <?php echo $kublik[$index]['piece'] === 0 ? "disabled" : "" ?>>Kosárba</button></div>
          </div>
          </form>
        </div>
      ...
      <div class="col-md-12 col-lg-6">
        ...
        <div class="termekleiras text-center py-3 m-2">
          ...
          <div class="row borbott text-left mx-2 p-2">
            ...
            <div class="col-8">3 dkg,</div>
          </div>
          <div class="row borbott text-left mx-2 p-2">
            <div class="col-4"><i class="fab fa-buffer"></i> Anyaga:</div>
            <div class="col-8">műanyag, vetex, szatén, strassz, gyöngy, fa, hungarocell</div>
          </div>
        </div>
        <div class="m-4 p-4">
      ...
      <div class="col-12 col-md-12 col-lg-6 p-3" id="haromviragoskubli">
        <div class="col-12 p-3 mt-5 pt-5">
        ...
        <form class="p-2" action="/cart" method="POST" id="kubliOrderSubmit">  
          <div class="row p-2" id="NamePiece" >
              ...
              <div class="col-6"><input class="w-30" id="kubliOrder" type="number" name="piece" size="5" min="1" max="<?php echo $kublik2[$index2]['piece'] ?>" <?php echo $kublik2[$index2]['piece'] === 0 ? "disabled" : "" ?>></input></div>
              <div class="col-6"><button type="submit" id="kubliOrderSender" class="btn btn-block btn-success" <?php echo $kublik2[$index2]['piece'] === 0 ? "disabled" : "" ?>>Kosárba</button></div>
          </div>
          </form>
        </div>
        <div class="row p-2 mx-4 ">
