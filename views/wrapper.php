...
<body>
  <div class="container">
    <nav id="mainNav" class="navbar fixed-top navbar-expand-lg navbar-shrink tatu-nav">
      ...
      <div class="container">
        <div class="card card-body backcol2 pt-4" id="contact">
          <div class="row p-2">
            ...
            <div class="col-12 col-md-6 card img-hover-zoom">
  ...
  <footer class="border-shadow mt-2">
    <div class="border-shadow">
      <div class="row border-shadowpx-5">
        <div class="col-3 py-4 text-right"><h1><a href="https://www.facebook.com/Vir%C3%A1gt%C3%BCnd%C3%A9r-M%C5%B1helye-101123411845057" target="_blank" class="mellow"><i class="fab fa-facebook-square my-2"></i></a></h1></div>
        <div class="col-2 text-right py-4 my-3"><h2><a href="#contact" class="mellow my-2"><i class="fas fa-envelope"></i>  Kapcsolat</a></h2></div>
        <div class="col-2 px-5 text-center"><img class="img-fluid col-11 px-3" src="./public/img/logo2.png" alt=""></div>
        <div class="col-2 text-left py-4 my-3"><h2><a href="" class="mellow my-2"><i class="fas fa-user-cog"></i>  Admin</a></h2></div>
        <div class="col-3 py-4"><h1><a href="https://accounts.google.com/ServiceLogin/signinchooser?passive=1209600&continue=https%3A%2F%2Faccounts.google.com%2F&followup=https%3A%2F%2Faccounts.google.com%2F&flowName=GlifWebSignIn&flowEntry=ServiceLogin" target="_blank" class="mellow"><i class="fab fa-google-plus-square my-2"></i></a></h1></div>
      </div>
    </div>
  </footer>
